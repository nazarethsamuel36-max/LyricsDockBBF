  ...
  return (
    <div className="flex justify-center h-dvh bg-black">
      <div className="flex flex-col min-h-0 w-full max-w-md md:max-w-5xl lg:max-w-7xl bg-[#121214] overflow-hidden md:border-x md:border-zinc-850">
        ...
        {/* ── Search header ── */}
        <div className="flex-shrink-0 border-b border-zinc-800/80 bg-[#121214] px-4 py-3">
        ...
        {/* ── Song list ── only this region scrolls ── */}
        <div className="flex-1 min-h-0 overflow-hidden">
          <SongLibrary onSongSelect={handleSongSelect} />
        </div>

        {/* ── Bottom navigation ── */}
        <div className="flex-shrink-0 bg-[#121214] shadow-[0_-4px_24px_rgba(0,0,0,0.2)]">
          <BottomNavigation />
        </div>
